...
Public Class FormDisplay
    ...
    Sub cargardatos(ByRef Elchart As Chart)
        Try
            ...
            LblFechaHora.Text = fechaserver.ToShortDateString & " " & fechaserver.ToShortTimeString
            ...
            da.SelectCommand.CommandText = "SELECT * FROM [hmo].[GetHourlyProdTable] (" & CurrAssetID & ",'" & CurrShiftName & "','" & CurrFecha.ToString("MM/dd/yyyy") & "'," & CurrSubResID & ")"
            ...
            Elchart.Series(0).Enabled = False
            Elchart.Series(3).Enabled = False
            ...
            For i = 0 To Elchart.Series(1).Points.Count - 1
                ...
                Select Case AheadBehind
                    ...
                    Case Is < 0
                        ...
                        If (Elchart.Series(1).Points(i).YValues(0) * 100) / Elchart.Series(0).Points(i).YValues(0) < 80 Then
