Public Class NewPlannedDowntime
    ...
    Private Sub RadButton1_Click(sender As Object, e As EventArgs) Handles RadButton1.Click
        Try
            ...
            If TotalMins + (NumericUpDown1.Value - CurrentMinsValue) > 60 Then
                ErrorProvider1.Clear()
                ErrorProvider1.SetError(NumericUpDown1, "Sobrepasa la cantidad de minutos permitidos en la hora")
                Exit Sub
            End If
            If Editar Then
                ...
                MsgBox("Registro de paro planeado Modificado exitosamente", MsgBoxStyle.Information, "Nuevo Tiempo Muerto")
            ...
            Else
                ...
                MsgBox("Registro de paro planeado Generado exitosamente", MsgBoxStyle.Information, "Nuevo Tiempo Muerto")
                Me.DialogResult = Windows.Forms.DialogResult.OK
            End If
        Catch ex As Exception
            MsgBox(ex.Message, MsgBoxStyle.Critical, "Error")
