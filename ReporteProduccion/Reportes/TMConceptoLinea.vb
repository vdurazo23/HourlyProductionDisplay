...
Public Class TMConceptoLinea
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ReporteProduccion.TMConceptoLinea.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ASSETID() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedTMConceptoLinea
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TMConceptoLinea = New TMConceptoLinea()
        rpt.Site = Me.Site
        Return rpt
    End Function
